                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><?php echo $adminUser['adm_fname'].' '.$adminUser['adm_lastname']; ?></td>
                                <td class="hidden-phone"><?php echo $adminUser['adm_email']; ?></td>
                                <td class="hidden-phone"><?php echo ucwords($adminUser['adm_role']); ?></td>
                                <td class="center hidden-phone"><?php if($adminUser['adm_status']=='active'): ?>
															...
															<?php else: ?>
																<span class="label label-sm label-danger">
																	Inactive</span>
															<?php endif; ?></td>
                                <td class="hidden-phone"><a href="editadminuser.php?ref=<?php echo $adminUser['adm_id'];?>" class="btn btn-xs btn-info">
																	Edit
																</a>
