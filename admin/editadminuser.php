                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " required name="adm_fname" 
                                    value="<?php echo $adminUser['adm_fname'];?>" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " required name="adm_lastname"
                                    value="<?php echo $adminUser['adm_lastname'];?>" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="email" class="span6 " required name="adm_email" 
                                    value="<?php echo $adminUser['adm_email'];?>"/>
                                ...
                                <div class="controls">
                                    <select name="adm_role" class="form-control">
												<optgroup label="Select role">												
                                                    <option <?php if($adminUser['adm_role']=='superadmin') 
                                                    echo 'selected="selected"'; ?> 
                                                    value="superadmin">Super Admin</option>
                                                    <option <?php if($adminUser['adm_role']=='subadmin')
                                                     echo 'selected="selected"'; ?>
                            ...
                            <div class="control-group">
                                ...
                                <select name="adm_status" class="form-control">
												<optgroup label="Select status">												
                                                    <option <?php if($adminUser['adm_status']=='active')
                                                     echo 'selected="selected"'; ?>
                                                    value="active">Active</option>
                                                    <option <?php if($adminUser['adm_status']=='inactive')
                                                     echo 'selected="selected"'; ?>
