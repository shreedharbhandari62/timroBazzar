                ...
                <?php if (isset(($_SESSION['msg'])))  echo $_SESSION['msg']; unset($_SESSION['msg']);?>
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
                            <?php $products=getProductRequestsByUserId($conn, $_SESSION['user'] ['id']);
                            ...
                            <tr class="odd gradeX">
                                ...
                                <a href="addsealeddeal.php?ref=<?php echo $product['pro_id'];?>" onclick="return confirm('Product Purchase Success?');" class="btn btn-xs btn-success">
																	Bought
																</a>
                                <a href="editmyrequests.php?ref=<?php echo $product['pro_id'];?>" class="btn btn-xs btn-info">
																	Edit
																</a>

							    <a href="deleteproductrequest.php?ref=<?php echo $product['pro_id'];?>" onclick="return confirm('Really Deleting that request??');" class="btn btn-xs btn-danger">
																	Delete
																</a></td>
                            </tr>
                            <?php endforeach; ?>
